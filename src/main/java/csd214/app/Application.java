...
public class Application implements CommandLineRunner {
    ...
    public void searchByMaxPrice() {
        ...
        try {
            maxPrice = Double.parseDouble(input.nextLine().trim());
        } catch (NumberFormatException e) {
            System.out.println("Invalid price.");
            return;
        }

        List<ProductEntity> results = repository.findByPriceLessThan(maxPrice);
    ...
    public void searchByName() {
        ...
        List<ProductEntity> results = repository.findByNameContainingIgnoreCase(keyword);
